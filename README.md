...
- Cropped figure/chart/photo extraction into durable storage with authenticated asset preview, editable labels/descriptions, deletion controls, page geometry, and one-page Reader rescue scans
...
- Live document-level DOI, citation, summary, and tag refresh controls backed by durable Concordance jobs
...
- Domains management with searchable alphabetized nested trees, top-level/child creation, rename, move, color, soft delete, document-count visibility, and affected-document search/history updates
