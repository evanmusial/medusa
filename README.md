...
- Utilities workspace with Database maintenance actions for compaction, table-statistics optimization, document MD5 hash backfill from cache/durable storage, hidden import-cache cleanup with live counts, Docker/container footprint stats, runtime binary/package versions, HAProxy TLS/proxy stats, and backend-container restart with health polling
