...
- Related-paper recommendations with default hidden-existing filtering, Unpaywall/arXiv PDF availability enrichment, Google Scholar search links, DOI/title copy actions, DOI stashing, a sortable Stashes view with DOI copy, manual Sci-Hub DOI links, resolver-backed DOI imports, stash PDF uploads that enter the normal import queue, and DOI-match cleanup for already-imported stash targets
