...
- [x] Add systemd templates for portable server operation.
  - Acceptance: the repo includes a `medusa.service` template for the Docker Compose app stack plus release checker/apply units, and portable deployment docs describe enabling them on a server checkout.
