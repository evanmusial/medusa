...
IMPORT_PROCESSING_STEPS: tuple[dict[str, Any], ...] = (
    ...
    },
    {
        ...
        "default_enabled": True,
        "configurable": True,
        "description": "Audits low-text or scanned pages for OCR eligibility under the selected preset; Bibliography extraction can use visual OCR as a last-resort references rescue while broader OCR page-text persistence remains pending.",
