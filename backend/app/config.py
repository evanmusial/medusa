...
class Settings(BaseSettings):
    ...
    cache_ttl_seconds: int = Field(default=604_800, validation_alias="MEDUSA_CACHE_TTL_SECONDS")
    cache_max_payload_bytes: int = Field(default=33_554_432, validation_alias="MEDUSA_CACHE_MAX_PAYLOAD_BYTES")
